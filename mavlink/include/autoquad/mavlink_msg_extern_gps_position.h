...
/**
 * @brief Encode a extern_gps_position struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a extern_gps_position struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param extern_gps_position C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_extern_gps_position_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_extern_gps_position_t* extern_gps_position)
{
	return mavlink_msg_extern_gps_position_pack_chan(system_id, component_id, chan, msg, extern_gps_position->index, extern_gps_position->value1double, extern_gps_position->value2double, extern_gps_position->value3double, extern_gps_position->value1float, extern_gps_position->value2float, extern_gps_position->value3float, extern_gps_position->value4float, extern_gps_position->value5float, extern_gps_position->value6float, extern_gps_position->value7float, extern_gps_position->value8float, extern_gps_position->value9float, extern_gps_position->value10float, extern_gps_position->value11float, extern_gps_position->value12float);
}
...
#if MAVLINK_MSG_ID_EXTERN_GPS_POSITION_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_extern_gps_position_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t index, double value1double, double value2double, double value3double, float value1float, float value2float, float value3float, float value4float, float value5float, float value6float, float value7float, float value8float, float value9float, float value10float, float value11float, float value12float)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_extern_gps_position_t *packet = (mavlink_extern_gps_position_t *)msgbuf;
	packet->value1double = value1double;
	packet->value2double = value2double;
	packet->value3double = value3double;
	packet->value1float = value1float;
